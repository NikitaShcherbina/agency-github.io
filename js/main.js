...
$(function(){
	$( "#slider-range1" ).slider({
		...
		slide: function( event, ui ) {
			$( "#price1-1" ).val( ui.values[ 0 ] );
			$( "#price1-2" ).val( ui.values[ 1 ] );
		}
	});
	$( "#price1-1" ).val( $( "#slider-range1" ).slider( "values", 0 ));
	$( "#price1-2" ).val( $( "#slider-range1" ).slider( "values", 1 ));
});
...
$(function(){
	$( "#slider-range2" ).slider({
		...
		values: [ 12, 200 ],
		slide: function( event, ui ) {
			$( "#price2-1" ).val( ui.values[ 0 ] + "м²");
			$( "#price2-2" ).val( ui.values[ 1 ] + "м²");
		}
	});
	$( "#price2-1" ).val( $( "#slider-range2").slider( "values", 0 ) + "м²");
	$( "#price2-2" ).val( $( "#slider-range2").slider( "values", 1 ) + "м²");
});
...
$(function(){
	$( "#slider-range3" ).slider({
		...
		values: [ 1, 20 ],
		slide: function( event, ui ) {
			$( "#price3-1" ).val( ui.values[ 0 ] + "0000$");
			$( "#price3-2" ).val( ui.values[ 1 ] + "0000$");
		}
	});
	$( "#price3-1" ).val( $( "#slider-range3" ).slider( "values", 0 ) + "0000$");
	$( "#price3-2" ).val( $( "#slider-range3" ).slider( "values", 1 ) + "0000$");
});
...
$(function(){
	$( "#slider-range4" ).slider({
		...
		values: [ 0, 10 ],
		slide: function( event, ui ) {
			$( "#price4-1" ).val( ui.values[ 0 ] + "км");
			$( "#price4-2" ).val( ui.values[ 1 ] + "км");
		}
	});
	$( "#price4-1" ).val( $( "#slider-range4" ).slider( "values", 0 ) + "км");
	$( "#price4-2" ).val( $( "#slider-range4" ).slider( "values", 1 ) + "км");
});
